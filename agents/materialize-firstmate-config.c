...
static const char crew_dispatch[] =
    ...
    "  \"rules\": [\n"
    "    {\n"
    "      \"when\": \"explicit captain-selected Astra, or a documented consequential reasoning blocker remaining after a Sol-high pass with a bounded question and why ordinary Sol or narrower evidence cannot settle it\",\n"
    "      \"use\": {\n"
    "        \"harness\": \"pi\",\n"
    "        \"model\": \"gpt-6-astra\",\n"
    "        \"effort\": \"high\"\n"
    "      },\n"
    "      \"why\": \"Astra is an exceptional bounded consult only for a documented consequential blocker after Sol high, or an explicit captain choice. Record the blocker, exact decision question, and why another Sol pass or narrower evidence will not settle it. Stage, security label, subjective difficulty, quota, and outage are not exceptions.\"\n"
    "    },\n"
    "    {\n"
    ...
    "        \"effort\": \"max\"\n"
    "      },\n"
    "      \"why\": \"Luna max is the standing route for mechanical, fully specified edits; Sol owns routine high-reasoning work and Astra remains evidence-gated.\"\n"
    "    },\n"
    "    {\n"
    ...
    "        \"effort\": \"max\"\n"
    "      },\n"
    "      \"why\": \"Luna max is the standing route for well-scoped implementation; Sol owns routine high-reasoning work and Astra remains evidence-gated.\"\n"
    "    },\n"
    "    {\n"
    ...
    "        \"effort\": \"max\"\n"
    "      },\n"
    "      \"why\": \"Luna max drives no-mistakes, validation, CI, and unattended pipelines after the separate Firstmate review; no-mistakes stays on Pi, never auto.\"\n"
    "    }\n"
    "  ],\n"
    "  \"default\": {\n"
    "    \"harness\": \"pi\",\n"
