...
static const char crew_dispatch[] =
    ...
    "  \"rules\": [\n"
    "    {\n"
    "      \"when\": \"architecture, ambiguous diagnosis, planning, security analysis, explicit review, or poorly scoped exploratory work that needs high reasoning\",\n"
    "      \"use\": {\n"
    "        \"harness\": \"pi\",\n"
    "        \"model\": \"gpt-5.6-sol\",\n"
    "        \"effort\": \"high\"\n"
    "      },\n"
    "      \"why\": \"Keep GPT Sol for high-reasoning and unscoped work; do not spend Grok on that class to save quota.\"\n"
    "    },\n"
    "    {\n"
    "      \"when\": \"mechanical, fully specified edits such as a known config line, cask add, or rote rename\",\n"
    "      \"use\": {\n"
    "        \"harness\": \"pi\",\n"
    "        \"model\": \"xai/grok-4.6\",\n"
    "        \"effort\": \"medium\"\n"
    "      },\n"
    "      \"why\": \"Grok 4.6 medium is enough when the path is explicit and bounded.\"\n"
    "    },\n"
    "    {\n"
    "      \"when\": \"routine, well-defined, or well-scoped implementation work\",\n"
    "      \"use\": {\n"
    "        \"harness\": \"pi\",\n"
    "        \"model\": \"xai/grok-4.6\",\n"
    "        \"effort\": \"high\"\n"
    "      },\n"
    "      \"why\": \"Use Grok 4.6 liberally for implementation; high reasoning so quality is not compromised. GPT quota is scarce.\"\n"
    "    }\n"
    "  ],\n"
    "  \"default\": {\n"
    "    \"harness\": \"pi\",\n"
