...
static const char crew_dispatch[] =
    ...
    "        \"effort\": \"high\"\n"
    "      },\n"
    "      \"why\": \"Sol is scarce and strategic: at most one or two bounded high-reasoning passes on a ship.\"\n"
    "    },\n"
    "    {\n"
    ...
    "        \"effort\": \"medium\"\n"
    "      },\n"
    "      \"why\": \"Mechanical, fully specified edits stay on Grok so scarce Sol is reserved for at most one or two bounded high-reasoning passes.\"\n"
    "    },\n"
    "    {\n"
    ...
    "        \"effort\": \"high\"\n"
    "      },\n"
    "      \"why\": \"Well-scoped implementation stays on Grok; Sol remains scarce and is not the default implementation model.\"\n"
    "    },\n"
    "    {\n"
    ...
    "        \"effort\": \"high\"\n"
    "      },\n"
    "      \"why\": \"Unattended overnight no-mistakes must run on Grok after any Sol pass, never as an automatic Sol cadence.\"\n"
    "    }\n"
    "  ],\n"
    "  \"default\": {\n"
    "    \"harness\": \"pi\",\n"
