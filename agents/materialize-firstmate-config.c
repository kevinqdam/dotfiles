...
static const char crew_dispatch[] =
    ...
    "        \"effort\": \"medium\"\n"
    "      },\n"
    "      \"why\": \"Grok executes mechanical, fully specified edits; the high-reasoning default is Sol, not an automatic Astra reservation.\"\n"
    "    },\n"
    "    {\n"
    ...
    "        \"effort\": \"high\"\n"
    "      },\n"
    "      \"why\": \"Grok executes well-scoped implementation; Sol owns routine high-reasoning work and Astra is not a default implementation model.\"\n"
    "    },\n"
    "    {\n"
    ...
    "        \"effort\": \"high\"\n"
    "      },\n"
    "      \"why\": \"Grok drives validation and unattended pipelines after the separate Firstmate review; no-mistakes stays on Pi, never auto.\"\n"
    "    }\n"
    "  ],\n"
    "  \"default\": {\n"
    "    \"harness\": \"pi\",\n"
