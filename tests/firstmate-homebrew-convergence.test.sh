...
for package in "${@:4}"; do
  case "$package" in
    pi-coding-agent|herdr)
      ...
      ;;
    antigravity-cli|chatgpt|codex|ghostty|google-drive|google-chrome|google-gemini|grok-bot|iterm2|raycast|superwhisper|tailscale-app|visual-studio-code)
...
assert_eq 'upgrade --greedy --no-ask pi-coding-agent herdr antigravity-cli chatgpt codex ghostty google-drive google-chrome google-gemini grok-bot iterm2 raycast superwhisper tailscale-app visual-studio-code' "$(cat "$calls")"
for cask in antigravity-cli chatgpt codex ghostty google-drive google-chrome google-gemini grok-bot iterm2 raycast superwhisper tailscale-app visual-studio-code; do
