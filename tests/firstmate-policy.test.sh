...
const required = [
  ...
  "implementation worker implements, tests, lints, and drives no-mistakes/CI",
  ...
  "preserve the captain-selected Pi model, including an explicit OpenAI quota fallback",
